...
// Resultado acima 40 - Obesidade grau III(mórbida). 
...
function calcular(event){
    event.preventDefault(); //quando ok da pagina for clicado, ele não sumirá com os dados digitados.
    ...
    if (imc < 17) {
        ...
        resultado.innerHTML = "<br/> Seu resultado foi: " + imc.toFixed(2) + "<br> CUIDADO! Obesiade grau I!";
    }else if ( imc > 35 && imc <= 39.99){
        resultado.innerHTML = "<br/> Seu resultado foi: " + imc.toFixed(2) + "<br> CUIDADO! Obesiade grau II!";
    }else if ( imc > 40){
        resultado.innerHTML = "<br/> Seu resultado foi: " + imc.toFixed(2) + "<br> CUIDADO! Obesiade grau III!";
    }
}
