...
// btnText.innerText = "Input Texto";
// btnText.onclick = criandoInputsText;
// linhaGeral.appendChild = (btnText);


// let btnRadio = document.createElement("button");
// btnRadio.innerText = "Input Radio";
// btnRadio.onclick = criandoInputsRadio;
// linhaGeral.appendChild = (btnRadio);


// let btnParagrafo = document.createElement("button");
// btnParagrafo.innerText = "Paragrafos"
// btnParagrafo.onclick = criandoParagrafos;
// linhaGeral.appendChild = (btnParagrafo);


// let btnGeral = document.createElement("button");
// btnGeral.innerText = "Geral"
// btnGeral.onclick = criandoInputsRadio, criandoInputsText, criandoParagrafos;
// area4.appendChild = (btnGeral);
